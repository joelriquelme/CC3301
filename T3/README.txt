...
Ud. debe crear el archivo calzar.c y programar ahí la función
solicitada. Ya hay una plantilla para calzar.c en calzar.c.plantilla.
...
archivo calzar.zip que contiene calzar.c, con su solución,
y resultados.txt, con la salida de make run, make run-g y make run-san.

Ud. debe entregar por U-cursos el archivo calzar.zip.
