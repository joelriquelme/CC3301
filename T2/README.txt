...
Ud. debe crear el archivo alinear.c y programar ahí la función
solicitada. Ya hay una plantilla para alinear.c en alinear.c.plantilla.
...
archivo alinear.zip que contiene alinear.c, con su solución,
...
Entregue por U-cursos el archivo alinear.zip
