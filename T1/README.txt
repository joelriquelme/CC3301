...
Ud. debe crear el archivo concat.c y programar ahí la función
solicitada. Ya hay una plantilla para concat.c en concat.c.plantilla.
...
archivo concat.zip que contiene concat.c, con su solución,
...
Entregue por U-cursos el archivo concat.zip
